...
public class TaxpayerDataFromFilesTest {
  ...
  // fields used together with @Parameter must be public
    ...
    @Test
    public void addTaxpayersDataFromFilesIntoDatabaseTest() {
    	String afmInfoFilesFolderPath = "tests"+File.separator+"testFiles";
    	inputSystem.addTaxpayersIntoDatabase(afmInfoFilesFolderPath,expectedTaxpayersAfmInfoFiles);
    	
    	int expectedTaxpayers = expectedTaxpayersAfmInfoFiles.size();
    	
    	int actualTaxpayers = database.getTaxpayersArrayListSize();
    	
    	assertEquals(expectedTaxpayers, actualTaxpayers);
