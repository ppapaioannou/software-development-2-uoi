...
public class MainJFrameWindow {
	...
	private void initialize() {
		...
		taxationMainWindowJFrame.setTitle("Äéá÷åßñçóç öïñïëïãßáò");
		...
		JLabel label = new JLabel("Óõí. áñéèìüò öïñïëïãïýìåíùí:");
		...
		JButton openTaxpayerLoadDataJDialog = new JButton("Öüñôùóç äåäïìÝíùí öïñïëïãïýìåíïõ (-ùí)");
		...
		JButton showLoadedTaxpayersDataButton = new JButton("ÅìöÜíéóç ëßóôáò öïñïëïãïõìÝíùí");
		...
		openTaxpayerLoadDataJDialog.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				afmInfoFilesFolderChooser.setDialogTitle("ÅðéëÝîôå ôïí öÜêåëï ðïõ ðåñéÝ÷åé ôá <AFM>_INFO.* áñ÷åßá");
				...
				if(afmInfoFilesFolderChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
				    ...
				    JOptionPane.showMessageDialog(null, afmInfoFilesFolderPath, "ÄéáäñïìÞ öáêÝëïõ áñ÷åßùí åéóüäïõ", JOptionPane.INFORMATION_MESSAGE);
